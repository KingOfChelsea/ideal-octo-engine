<template>
  <div class="fake animate__bounce" v-if="flag" >
    <div class="right_left">

      <div class="Address">
       <RadarMap :radar="this.$route.query.Radar" />
      </div>
        ...
        <div class="card">
          <div class="content">
            ...
            <div class="description">
              ...
              <p class="info">{{ $route.query.Address }}</p>
              <p class="price">{{ $route.query.Price }}</p>
            </div>
            <div class="btn-container" @click="newa">
              <div class="svg svg-1">
                <svg
                ...
                >
                  ...
                  <g fill="#1d1d1b">
                    <path
                      d="m44.77 20.71a7.38 7.38 0 0 1 2.72 1.4c-.09.19.07.44-.34.44a10.38 10.38 0 0 1 -2.72-1.16 1.13 1.13 0 0 1 .34-.68z"
                    ></path>

                    <path
                      d="m43.81 22.64s4.25 1.94 4.25 2.22.18.47-.16.44a28.09 28.09 0 0 1 -4.5-1.94c-.06-.22.41-.72.41-.72z"
                    ></path>

                    <path
                      d="m41.77 24.08c.16 0 5.54 2.63 5.5 2.88s.13.5-.18.46a46.82 46.82 0 0 1 -5.72-2.42c.03-.23.28-.92.4-.92z"
                    ></path>

                    <path
                      d="m40.24 25.92c.1 0 4.32 1.94 4.22 2.13s-.06.34-.28.34a34.62 34.62 0 0 1 -4.34-1.65 2.24 2.24 0 0 1 .4-.82z"
                    ></path>
                  </g>
              ...
              <div class="svg svg-2">
                ...
                >
                  ...
                  <g fill="#1d1d1b">
                    <path
                      d="m39.84 25.4a21.45 21.45 0 0 1 4 1.72c.09.22.16.72 0 .75a33.77 33.77 0 0 1 -3.88-1.43c-.21-.16-.24-1-.12-1.04z"
                    ></path>

                    <path
                      d="m40 28a40.88 40.88 0 0 1 4.46 1.93c0 .22.1.5-.12.5a41.64 41.64 0 0 1 -4.38-1.46c-.15-.19-.21-.97.04-.97z"
                    ></path>

                    <path
                      d="m25 22.59a3.8 3.8 0 0 1 1.87-1.69c1.38-.59 2.22-.62 2.41-.43a.64.64 0 0 1 .12.68 13.46 13.46 0 0 0 -2.4.85c-.66.5-1.06 1.09-1.38 1.19s-.69-.41-.62-.6z"
                    ></path>

                    <path
                      d="m23.34 24.87c.31-.1 1.81.16 1.81.47a8.74 8.74 0 0 0 -.06 4c.56 1.78 1.72 4.44 1.53 5.28a1.47 1.47 0 0 1 -1.62 1.1 11.25 11.25 0 0 1 -3.6-1.35c-.81-.56-1.06-1.31-.93-3.12s1.93-6.06 2.87-6.38z"
                    ></path>
                  </g>
              ...
              <div class="svg svg-3">
                ...
                >
                  ...
                  <g fill="#1d1d1b">
                    <path
                      d="m36.51 20.36c.3-.25 2.25.82 2.18 1.38s.13.81-.18.75a9 9 0 0 1 -2.57-1.31c-.12-.32.19-.5.57-.82z"
                    ></path>

                    <path
                      d="m35.63 23.55c.18-.18 2.94 1.44 3 1.88s.38 1-.06.93-3.44-1.62-3.5-2 .37-.62.56-.81z"
                    ></path>

                    <path
                      d="m34.88 26.11c.31.07 4.19 1.82 4.06 2.25s.25.75-.31.63-4.19-1.75-4.19-2.25a.65.65 0 0 1 .44-.63z"
                    ></path>

                    <path
                      d="m29.32 34.08c.35-.26 1 .25 2.66.32s2.75 0 2.75 0 .12.62 0 .81a9.3 9.3 0 0 1 -2.69.28 12 12 0 0 1 -2.85-.44.94.94 0 0 1 .13-.97z"
                    ></path>

                    <path
                      d="m29.35 39c.35-.27 1 .25 2.66.31s2.75 0 2.75 0 .12.63 0 .81a9 9 0 0 1 -2.69.28 12.47 12.47 0 0 1 -2.84-.43.91.91 0 0 1 .12-.97z"
                    ></path>

                    <path
                      d="m29.26 44.65c.35-.27 1 .25 2.65.31s2.75 0 2.75 0 .13.62 0 .81a8.85 8.85 0 0 1 -2.68.28 12 12 0 0 1 -2.85-.44.92.92 0 0 1 .13-.96z"
                    ></path>

                    <path
                      d="m49.82 38.65c.12.15 2.41 2.09 2.34 2.37s-.18.41-.28.34a31.15 31.15 0 0 1 -2.47-2c-.06-.15.41-.71.41-.71z"
                    ></path>

                    <path
                      d="m47.35 39.33c.28 0 4.22 3.19 4.16 3.57s-.16.62-.32.62-4.43-3.31-4.4-3.59.56-.6.56-.6z"
                    ></path>

                    <path
                      d="m46.29 41.93a12.19 12.19 0 0 1 2.9 2.12c-.12.16.29.38-.37.35a9.48 9.48 0 0 1 -3-1.72c-.06-.19.31-.68.47-.75z"
                    ></path>
                  </g>
              ...
              <div class="svg svg-4">
                ...
                >
                  ...
                  <g fill="#1d1d1b">
                    <path
                      d="m11.36 25.18a19.09 19.09 0 0 1 1.16-3.65c.5-.75.72-.91.94-.85s.84.35.78.53-1.13 2.25-1.41 3.16 0 .91-.4 1-.94.03-1.07-.19z"
                    ></path>

                    <path
                      d="m40 15.59c.16-.14 2.53-.72 2.69-.5s.34.44.18.56a11.75 11.75 0 0 1 -2.62.94c-.2-.1-.45-.85-.25-1z"
                    ></path>

                    <path
                      d="m38.46 22.93c.15.16 1.47 2.28 1.31 2.47s0 .47-.34.31a6.24 6.24 0 0 1 -1.54-2.22c.11-.25.57-.56.57-.56z"
                    ></path>

                    <path
                      d="m37 24.37a12.18 12.18 0 0 1 1.72 2.09c0 .19 0 .47-.31.38a8.07 8.07 0 0 1 -1.86-1.84c0-.16.45-.66.45-.63z"
                    ></path>

                    <path
                      d="m49.33 19.65a7.18 7.18 0 0 1 2.5 1.22c0 .19.1.69-.15.59s-2.54-1-2.63-1.12.25-.66.28-.69z"
                    ></path>

                    <path
                      d="m49.11 22c.08-.11 4 2.18 4 2.53s.35.59-.06.53a30.17 30.17 0 0 1 -4.25-2.16c-.12-.19.2-.75.31-.9z"
                    ></path>

                    <path
                      d="m48.74 24a25.43 25.43 0 0 1 4.84 2.62c.06.28.28.59-.12.56a40.58 40.58 0 0 1 -4.94-2.37c-.09-.13.09-.75.22-.81z"
                    ></path>

                    <path
                      d="m49.68 35.53a13.17 13.17 0 0 1 2.9 2.78c-.09.25 0 .37-.28.28a22.37 22.37 0 0 1 -3.12-2.72c.06-.16.34-.28.5-.34z"
                    ></path>

                    <path
                      d="m48.11 37.43a28.41 28.41 0 0 1 3.35 3.16c0 .25-.13.47-.25.44a41.72 41.72 0 0 1 -3.44-3 4.75 4.75 0 0 1 .34-.6z"
                    ></path>

                    <path
                      d="m47.11 39.46a23.35 23.35 0 0 1 3.35 3.32c-.07.25.06.4-.25.37a39.21 39.21 0 0 1 -3.53-3.15 3.19 3.19 0 0 1 .43-.54z"
                    ></path>

                    <path
                      d="m46.33 41.12a29.14 29.14 0 0 1 3.41 3.28c0 .25-.1.41-.22.31a43.92 43.92 0 0 1 -3.84-3.09.84.84 0 0 1 .65-.5z"
                    ></path>

                    <path
                      d="m45.71 44.12a16 16 0 0 1 3.06 2.72c0 .22-.16.37-.25.34a33.63 33.63 0 0 1 -3.19-2.5c-.03-.19.31-.53.38-.56z"
                    ></path>

                    <path
                      d="m45 45.93c.17 0 3.25 2.69 3 2.94s-.12.37-.37.28a22.27 22.27 0 0 1 -3.13-2.69c.11-.15.33-.53.5-.53z"
                    ></path>

                    <path
                      d="m35.18 43.43c.09-.14 1.31.31 1.28.6s0 .34-.16.34a5 5 0 0 1 -1.53-.44c0-.12.34-.4.41-.5z"
                    ></path>

                    <path
                      d="m33.14 47.28a1.46 1.46 0 0 1 1.16 0c.47.22 1.16 1 1.78 1.1s1.1-.28 1.25-.19a.37.37 0 0 1 .16.47c-.1.16-.16.31-.41.37a2 2 0 0 1 -1.5-.15c-.58-.39-.94-.88-1.58-.88s-.57.12-.69 0-.42-.51-.17-.72z"
                    ></path>

                    <path
                      d="m26 40.15c.25.16 2.06 1.75 2 2s-.19.5-.38.44a10.1 10.1 0 0 1 -2.15-1.82c-.01-.24.53-.62.53-.62z"
                    ></path>

                    <path
                      d="m24.21 30.43c.12 0 2.81 4.19 2.59 4.41s-.34.44-.47.31a44.75 44.75 0 0 1 -2.84-4.34 1.31 1.31 0 0 1 .72-.38z"
                    ></path>

                    <path
                      d="m25.24 30c0-.12.59-.38.78-.19a12 12 0 0 1 1.37 2.72c-.09.18 0 .47-.25.28a17.6 17.6 0 0 1 -1.9-2.81z"
                    ></path>

                    <path
                      d="m30.74 29.71c.08-.11 1-1 1.28-1s1 0 .91.22-1.41 1.91-1.66 1.75a1.66 1.66 0 0 1 -.53-.97z"
                    ></path>
                  </g>
                </svg>
              </div>
              <div class="svg svg-5">
                ...
                >
                  <g fill="#1d1d1b">
                    <path
                      d="m15.69 55.54a2.75 2.75 0 0 0 -.62-2.69 2.37 2.37 0 0 0 -2.72-.47s-1.88-2-2.6-.65.79 2.69.79 2.69a1.9 1.9 0 0 0 .46 2.34 2.88 2.88 0 0 0 2.6.37s2.37 1.6 3 .44-.91-2.03-.91-2.03zm-4.84-1.72s-.91-1.09-.53-1.56 1.56.47 1.56.47-.97 1.09-1.03 1.09zm4.94 3.38c-.32.22-1.16-.38-1.16-.38l.44-.69c.28.16 1.03.87.72 1.07z"
                    ></path>

                    <path
                      d="m27 33.1c.05-.53-3.81-2.25-3.87-7.18s2.37-9 8.31-10.19 8.5-.13 8.94-.56.75-2.75-2.75-4.82-14.16-3.35-22.47 4.57-7.44 16.46-6.59 19.87a20.86 20.86 0 0 0 8 11.91c4.84 3.34 7.53 4.43 11.78 5.09s8.75-1.41 11.19-3.06 3-3.41 2.93-4.16-.9-1.94-1.46-1.78-5.13 2.22-9.22 1-5.35-4-5.32-6 .41-3.5.53-4.69z"
                    ></path>

                    <path
                      d="m7.79 8.7c.23-.08 1.71.12 1.78 0s.25-2.16.72-2.1.53 1.72.87 1.78 1.66-.09 1.75.25-1.09 1.35-1.06 1.5.25.88 0 1-1.25-.28-1.28-.18-1.32 1.68-1.57 1.56-.5-.16-.46-.34.62-2.17.62-2.17l-1.5-.8c-.16-.1-.06-.44.13-.5z"
                    ></path>

                    <path
                      d="m7.16 18.73c.76-.47 1.28 0 1.13.84a.88.88 0 0 1 -1.38.53.89.89 0 0 1 .25-1.37z"
                    ></path>

                    <path
                      d="m37.29 4.82a1.71 1.71 0 0 1 2.4 1.69 1.8 1.8 0 0 1 -3 1.16 1.74 1.74 0 0 1 .6-2.85z"
                    ></path>
                  </g>
    ...
    <div class="right_right">
      <div class="graph">
        <Weather :Bigcity="this.$route.query.City" />
        <BackButton />
        <Rocket :Name="this.$route.query.Name" @click.native="newMap($route.query.Name)"/>
      </div>
      <!-- $route.query.Big_Infro -->
      <Comment :infor="this.Infor"/>
    </div>
  </div>
</template>

<script>
import Address from "@/AboutComponent/Component/Address.vue"
import BackButton from "@/AboutComponent/Component/BackButton.vue"
import Comment from "@/AboutComponent/Component/Comment.vue"
import Rocket from "@/AboutComponent/Component/Rocket.vue"
import Weather from "@/AboutComponent/Component/Weather.vue"
import RadarMap from "@/MEEChart/RadarMap.vue"
export default {
  name: "Right",
  components: {
    Address,
  ...
  computed: {
    ...
    Infor:function(){
      return this.$route.query.Big_Infro
    }  
},
// 监听全局事件总线上的自定义事件,用于接受外部数据改变
  mounted() {
    // 使用 $bus 全局事件总线监听了一个名为 "sendingFlag" 的自定义事件，当事件被触发时，将会执行回调函数，将传递的 data 赋值给组件的 flag 属性
    this.$bus.$on("sendingFlag", (data) => {
      this.flag = data;
    });
    //  获取当前路由的查询参数 City 的值，并赋值给组件的 city 属性。
    this.city = this.$route.query.City;
  },
  // watch 用于监听 Bimg 的变化，当 Bimg 的值变化时，会执行回调函数。
  watch: {
    Bimg(val){
      this.$bus.$emit("sendBackground",val)
      console.log(this.Bimg);
      console.log("success");
    },   
  },
  //  定义了组件的方法,如点击分享、在新页面打开地图等
  methods: {
    //点击事件处理函数，当被调用时会在新窗口中打开一个链接，链接地址包括当前路由的查询参数 Name 的值。
    newa: function () {
      window.open(`http://piao.qunar.com/ticket/list.htm?keyword=${this.$route.query.Name}`);
    },
    // 是一个接受 data 参数的方法,用于在新窗口中打开一个包含 data 的地图页面
    newMap: function (data){
      // 它通过 $router.resolve 方法生成包含参数的路由地址，
